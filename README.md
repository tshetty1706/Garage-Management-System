...
A backend-focused web application built with Spring Boot, MYSQL fro backend and a custom HTML/CSS/JavaScript frontend. This system allows customers to manage vehicles and book services, while administrators <br>manage users, services, previously owned sales vehicles, and system activities..
